...
import { SongVisualiser } from '@/components/song-visualiser'
...
export function SongTransport({
	...
	/** Where the track's energy sits in the spectrum over its length. The bars' colour. */
	...
	return (
		<div className="transport mt-6">
			...
			<div className="transport-rail">
				...
				>
					<SongVisualiser songId={song.id} peaks={peaks} tone={tone} />
				</div>
