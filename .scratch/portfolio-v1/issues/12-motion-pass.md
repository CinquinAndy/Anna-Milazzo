...
`background-attachment: fixed`, no preloader element, and no magnetic behaviour anywhere —
magnetism is smooth and organic and contradicts the mechanical-press metaphor the whole
style rests on.
